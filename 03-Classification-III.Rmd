...
[^03-classification-iii-1]: La fonction `over_undersample()` sera incluse dans la prochaine version du package {mlearning}, donc pour la SciViews Box 2024.
...
if (exists("assignment"))
  assignment("C03Ia_cardiovascular", part = "I",
    ...
    course.urls = c(
      'S-BIOG-025'         = "https://classroom.github.com/a/PbZWCAUY"),
    course.starts = c(
...
if (exists("challenge"))
  challenge("C03Ca_ml_wine", part = NULL,
    ...
    course.urls = c(
      'S-BIOG-025' = "https://classroom.github.com/a/Rejeo-A4",
      'sdd3late'   = "https://classroom.github.com/a/Rejeo-A4"),
    course.starts = c(
...
-   [Torch for R](https://torch.mlverse.org/), une autre librairie de fonctions dédiée au "deep learning" (torch est réputé pour être plus facile et plus intuitif que Tensorflow). En anglais.
